...
public class EdgeLabel extends JLabel implements Shape, MouseInputListener, Serializable {
	...
	private void changeRelatedLabel(String label) {
		...
		while (currentEdge.getSource() instanceof Edge) {
			Edge jp = (Edge) currentEdge.getSource();
		...
		currentEdge = edge;
		while (currentEdge.getDest() instanceof Edge) {
			Edge jp = (Edge) currentEdge.getDest();
