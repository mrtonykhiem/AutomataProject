...
public class Automata {
	...
	public void addState(Shape shape)
	{
		...
		} else if (shape instanceof FinishState) {
	...
	public void recognizeAutomata(String word, final Vector<Shape> shapes) {
